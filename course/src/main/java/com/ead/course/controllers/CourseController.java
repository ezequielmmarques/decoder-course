...
@Tag(name = "Courses", description = "Service para CRUD de cursos")
@RestController
...
public class CourseController {
    ...
    @GetMapping
    public ResponseEntity<Page<CourseModel>> getAllCourse(SpecificationTemplate.CourseSpec courseSpec,
